...
func (_c *ContractBackend_EstimateGas_Call) Return(_a0 uint64, _a1 error) *ContractBackend_EstimateGas_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *ContractBackend) FilterLogs(ctx context.Context, q ethereum.FilterQuery) ([]types.Log, error) {
	ret := _m.Called(ctx, q)
...
func (_e *ContractBackend_Expecter) FilterLogs(ctx interface{}, q interface{}) *ContractBackend_FilterLogs_Call {
	return &ContractBackend_FilterLogs_Call{Call: _e.mock.On("FilterLogs", ctx, q)}
}

func (_c *ContractBackend_FilterLogs_Call) Run(run func(ctx context.Context, q ethereum.FilterQuery)) *ContractBackend_FilterLogs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *ContractBackend) SubscribeFilterLogs(ctx context.Context, q ethereum.FilterQuery, ch chan<- types.Log) (ethereum.Subscription, error) {
...
//   - q ethereum.FilterQuery
//   - ch chan<- types.Log
func (_e *ContractBackend_Expecter) SubscribeFilterLogs(ctx interface{}, q interface{}, ch interface{}) *ContractBackend_SubscribeFilterLogs_Call {
	return &ContractBackend_SubscribeFilterLogs_Call{Call: _e.mock.On("SubscribeFilterLogs", ctx, q, ch)}
}

func (_c *ContractBackend_SubscribeFilterLogs_Call) Run(run func(ctx context.Context, q ethereum.FilterQuery, ch chan<- types.Log)) *ContractBackend_SubscribeFilterLogs_Call {
	_c.Call.Run(func(args mock.Arguments) {
